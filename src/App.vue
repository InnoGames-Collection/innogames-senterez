                ...
                <md-card>
                    ...
                    <div slot="reveal">
                      <span class="card-title grey-text text-darken-4">
                        ...
                        <p>
                            Vue.js, Node.js, Socket.IO, MongoDB, Webpack
                        </p>
                        <h5 class="flat-text-header hello">{{ $t("about.dev") }}</h5>
                        <p>
                            {{ $t("about.developer") }}
                        </p>
                        <h5 class="flat-text-header hello">{{ $t("about.license") }}</h5>
                        <p>
                            {{ $t("about.licenseText") }}
                        </p>
                    </div>
...
<script>
/**
 * Senterez (ሰንጠረዥ) — online multiplayer chess
 * Copyright (C) 2026 InnoSphere Technologies
